...
public class BaseActivity extends FragmentActivity
{
    ...
    private void initData()
    {
        AppConfig.getInstance()
                .setSessionId(PreferencesUtils.getAttrString(Common.KEY_SESSION_ID));
        AppConfig.getInstance()
                .setUid(PreferencesUtils.getAttrString(Common.KEY_USER_ID));
    }
    ...
    private void removeHandler()
    {
        if (mHandler != null)
        {
            ...
            else if (mBaseLogicBuilder != null)
            {
    ...
    {
        boolean pushFlag = getSharedPreferences().getBoolean(Common.PUSH_BIND_FLAG,
                false);
        if (!pushFlag)
        {
