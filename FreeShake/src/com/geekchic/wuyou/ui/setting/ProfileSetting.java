...
public class ProfileSetting extends BaseTitleBarActivity implements
	...
	private void initView() {
		...
		mShareEditView=findViewById(R.id.set_bind_account);
		...
		mShareEditView.setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		case R.id.set_bind_mail:
			...
			.create().show();
			break;
		case R.id.set_bind_account:
		    Intent shareIntent=new Intent(AppAction.ShareAction.ACTION);
