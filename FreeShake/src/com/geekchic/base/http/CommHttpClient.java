...
{
    private static final String TAG = CommHttpClient.class.getName();
    ...
    public static HttpClient getNewInstance(Context mContext)
    {
        ...
        switch (checkNetworkType(mContext))
        {
            case TYPE_CT_WAP:
            {
                ...
                Logger.i(TAG, "当前网络类型为cm_cu_wap,设置代理10.0.0.200访问www");
            }
                break;
            case TYPE_CM_CU_WAP:
            {
                ...
                newInstance.getParams()
                        .setParameter(ConnRoutePNames.DEFAULT_PROXY, proxy);
                Logger.i(TAG, "当前网络类型为cm_cu_wap,设置代理10.0.0.172访问www");
            }
                break;
        }
        return newInstance;
