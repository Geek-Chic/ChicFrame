...
public class RegisterView extends ResizeLayout
{
    ...
    private void initView(Context context)
    {
        ...
        LinearLayout.LayoutParams webLayoutParams = new android.widget.LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.MATCH_PARENT,
                RelativeLayout.LayoutParams.WRAP_CONTENT);
        webLayoutParams.weight = 1.0f;
        mWebView.setLayoutParams(webLayoutParams);
        DefaultWebChromeClient webChromeClient = new DefaultWebChromeClient(
                this, textview, width);
